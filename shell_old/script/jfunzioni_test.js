...
function avantitest(pagina,destinazione,destinazione2){ // accede alla pagina tutoriale o a quella alternativa
	...
	if (nodovisitato[pagina] < 3)
		inviamessaggio("Prima rispondi bene!",pagina,"messaggio");
		...
		switch (tipotutoriale[destinazione]){
			case 4: // riepilogo
				...
				var classepunteggio = (punteggiomassimo - punteggio)/(punteggiomassimo / 4);
				if (classepunteggio > 4){
					document.getElementById("feedback"+destinazione).src = "riepilogo_01.jpg";
					...
					document.getElementById("feedback"+destinazione).src = "riepilogo_02.jpg";
					...
					document.getElementById("feedback"+destinazione).src = "riepilogo_03.jpg";
					...
					document.getElementById("feedback"+destinazione).src = "riepilogo_04.jpg";
					...
					document.getElementById("feedback"+destinazione).src = "riepilogo_05.jpg";
...
/* -- ESERCITAZIONI/TEST -- */
function verificatest(tipotest,pagina,rispostaesatta,punti,messaggiook,messaggioko){ // verifica test
	numeroerrore = -1;
	var contatore = 1;
	var risposta = 0;
	if (!messaggiook)
	...
	switch (nodovisitato[pagina]){
		case 1:
			...
			break;
		case 2:
			inviamessaggio("Prima di ritentare, studia!",pagina,"messaggio");
			break;
		case 3:
			inviamessaggio("Hai già risposto. Vai avanti.",pagina,"messaggio");
			break;
	}
}
...
function rispostatest(risposta,pagina,punti,messaggiook,messaggioko){
	switch (risposta){
		case 0:
			inviamessaggio("Non hai ancora risposto!",pagina,"messaggio");
			break;
		case 2:
			nodovisitato[pagina] = 3;
			inviamessaggio(messaggiook,pagina,"ok");
			punteggio = punteggio + punti;
			break;
		case 1:
			nodovisitato[pagina] = 2;
			inviamessaggio(messaggioko,pagina,"ko");
			punteggio = punteggio - punti;
			roll('studio',pagina);
			break;
		}
