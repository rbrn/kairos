...
HTMLArea.Config = function () {
	...
	this.toolbar = [
		...
		[ "justifyleft", "justifycenter", "justifyright", "justifyfull", "separator",
		  ...
		  "popupeditor", "separator", "about", "separator", "insertflash" ]
	];
	...
	this.btnList = {
		...
		insertflash: [ "Insert Flash", "insert_flash.gif", false, function(e) {e.execCommand("insertflash");} ]
	};
...
HTMLArea.prototype._insertFlash = function(flash) {
	var editor = this;	// for nested functions
	var outparam = null;
	if (typeof flash == "undefined") {
		flash = this.getParentElement();
		if (flash && !/^img$/i.test(flash.tagName))
			flash = null;
	}
	if (flash) outparam = {
		f_url    : HTMLArea.is_ie ? editor.stripBaseURL(flash.src) : flash.getAttribute("src"),
		f_alt    : flash.alt,
		f_border : flash.border,
		f_align  : flash.align,
		f_vert   : flash.vspace,
		f_horiz  : flash.hspace
	};
