...
function tutoriale(pagina,ritorno){ // visualizza la pagina prescelta e gestisce il menÃÂÃÂ¹
	var blocco = pagina;
	finemedium();
	...
	if (puntatorestack != ""){ // modalitÃÂÃÂ  protetta
	...
	switch (tipotutoriale[blocco]){// tipo tutoriale
		...
		case 4: // riepilogo
			...
			if (classepunteggio > 4){
				document.getElementById("feedback_"+blocco).src = "shell/<?php echo($path_img);?>/riepilogo_01.gif";
				...
				document.getElementById("feedback_"+blocco).src = "shell/<?php echo($path_img);?>/riepilogo_02.gif";
				...
				document.getElementById("feedback_"+blocco).src = "shell/<?php echo($path_img);?>/riepilogo_03.gif";
				...
				document.getElementById("feedback_"+blocco).src = "shell/<?php echo($path_img);?>/riepilogo_04.gif";
				document.getElementById("feedback_"+blocco).alt = messaggiofeedback[4];
				inviamessaggio(messaggiofeedback[9],blocco);
			}
			else{
				document.getElementById("feedback_"+blocco).src = "shell/<?php echo($path_img);?>/riepilogo_05.gif";
	...
	if (tutorialeprincipale[blocco] != null){// indice
		document.getElementById("sommarioimm_"+tutorialeprincipale[blocco]).src = "shell/<?php echo($path_img);?>/visto.gif";
		...
		document.getElementById("sommarioimm_"+blocco).src = "shell/<?php echo($path_img);?>/visto.gif";
...
function comandi(pagina,tipotest,rispostaesatta,tutorialetest,messaggio,animazione){ //inserisce i comandi nascosti per gestire audio, video e animazioni
	...
	switch (tipotutoriale[pagina]){
		case 2:
				...
				document.write("<img class='pulsanteverifica' onMouseOver='roll(this,\"verifica\")' onMouseOut='noroll(this,\"verifica\")' src='shell/<?php echo($path_img);?>/pulsante_verifica.gif' alt='Verifica la risposta'></a>");
				...
				document.write("<img id='pulsantesoluzioni_"+pagina+"' class='pulsantesoluzioni' onMouseOver='roll(this,\"soluzioni\")' onMouseOut='noroll(this,\"soluzioni\")' src='shell/<?php echo($path_img);?>/pulsante_soluzioni.gif' alt='Mostra le soluzioni'></a>");
			...
			if (tipolo != "c"){ // diverso da solo test
				...
				document.write("<img class='pulsantestudio' onMouseOver='roll(this,\"studio\")' onMouseOut='noroll(this,\"studio\")' src='shell/<?php echo($path_img);?>/pulsante_studio.gif' alt='Studia'></a>");

				if (animazione){
					stringa = "'studioanimazione("+"\""+animazione+"\""+");return false'";
					document.write("<a href='#' accesskey='s' tabindex='160' onClick="+stringa+" onKeyPress="+stringa+">");
					document.write("<img class='pulsanteanimazione' onMouseOver='roll(this,\"animazione\")' onMouseOut='noroll(this,\"animazione\")' src='shell/<?php echo($path_img);?>/pulsante_animazione.gif' alt='Rivedi'></a>");
				}
			}
			break;
		case 5:
			...
			document.write("<img class='pulsanteinvia' onMouseOver='roll(this,\"invia\")' onMouseOut='noroll(this,\"invia\")' src='shell/<?php echo($path_img);?>/pulsante_invia.gif' alt='Invia il commento'></a>");
	}
}
...
function inizializza(){ // nasconde tutte le pagine tranne la home e imposta i parametri iniziali
	...
	while (nometutoriale[contatore]){
		...
		if (nodovisitato[nometutoriale[contatore]] > 0 && tutorialeprincipale[nometutoriale[contatore]] == null){
			document.getElementById("sommarioimm_"+nometutoriale[contatore]).src = "shell/<?php echo($path_img);?>/visto.gif";
...
function roll(elemento,immagine){ // carica l'immagine di rollover
	elemento.src = "shell/<?php echo($path_img);?>/pulsante_"+immagine+"_r.gif"
}

function noroll(elemento,immagine){ // ricarica l'immagine normale
	elemento.src = "shell/<?php echo($path_img);?>/pulsante_"+immagine+".gif";
}
...
function comunicaplugin(){ // elenca i plug-in disponibili
	...
	if (plugin_qt + plugin_wm + plugin_rp == 0)
		comunicazione = "Per gestire audio e video ÃÂÃÂ¨ necessario installare Windows Media Player, Real Player, QuickTime.<br>";
	if (plugin_fl == 0)
		comunicazione = comunicazione + "Per le animazioni ÃÂÃÂ¨ necessario Flash.";
	if (plugin_ja == 0)
		comunicazione = comunicazione + " Per le applet ÃÂÃÂ¨ necessario Java.";
	if (comunicazione != "")
...
function pulsantiambiente(){
	...
	if (dimensionipagina==2)
		document.write("<a href='#' onClick='diminuiscizoom();return false;' onKeypress='diminuiscizoom();return false;'><img class='pulsantezoom' onMouseOver=\"roll(this,'zoom')\" onMouseOut=\"noroll(this,'zoom')\"  src='shell/<?php echo($path_img);?>/pulsante_zoom.gif' alt='Rimpicciolisci la finestra'><\/a>");
	else
		document.write("<a href='#' onClick='aumentazoom();return false;' onKeypress='aumentazoom();return false;'><img class='pulsantezoom' onMouseOver=\"roll(this,'zoom')\" onMouseOut=\"noroll(this,'zoom')\" src='shell/<?php echo($path_img);?>/pulsante_zoom.gif' alt='Ingrandisci la finestra'><\/a>");
	document.write("<\/span>");
	document.write("<a href='#' onClick='incrementa();return false;' onKeypress='incrementa();return false;'><img class='pulsanteingrandisci' onMouseOver=\"roll(this,'ingrandisci')\" onMouseOut=\"noroll(this,'ingrandisci')\" src='shell/<?php echo($path_img);?>/pulsante_ingrandisci.gif' alt='Ingrandisci i caratteri'><\/a>");
	document.write("<a href='#' onClick='decrementa();return false;' onKeypress='decrementa();return false;'><img class='pulsanterimpicciolisci' onMouseOver=\"roll(this,'rimpicciolisci')\" onMouseOut=\"noroll(this,'rimpicciolisci')\"  src='shell/<?php echo($path_img);?>/pulsante_rimpicciolisci.gif' alt='Rimpicciolisci i caratteri'><\/a>");
	document.write("<a id='pulsantesuonoon' href='#' onClick='attivamedium();return false;' onKeypress='attivamedium();return false;'><img class='pulsantesuono' onMouseOver=\"roll(this,'suonoon')\" onMouseOut=\"noroll(this,'suonoon')\" src='shell/<?php echo($path_img);?>/pulsante_suonoon.gif' alt=\"Attiva audio, video e animazioni\"><\/a>");
	document.write("<a id='pulsantesuonoff' href='#' onClick='disattivamedium();return false;' onKeypress='disattivamedium();return false;'><img class='pulsantesuono' onMouseOver=\"roll(this,'suonooff')\" onMouseOut=\"noroll(this,'suonooff')\" src='shell/<?php echo($path_img);?>/pulsante_suonooff.gif' alt=\"Disattiva audio, video e animazioni\"><\/a>");
}
...
function pulsantinavigazione(){
	...
	document.write("<a id='pulsanteindietro' href='#' accesskey='o' tabindex='200' onClick='muovi(2);return false;' onKeypress='muovi(2);return false;'><img id='indietro' onMouseOver=\"roll(this,'indietro')\" onMouseOut=\"noroll(this,'indietro')\" src='shell/<?php echo($path_img);?>/pulsante_indietro.gif' alt=\"Indietro\"><\/a>");
	document.write("<a id='pulsanteavanti' href='#' accesskey='a' tabindex='210' onClick='muovi(1);return false;' onKeypress='muovi(1);return false;'><img id='avanti' onMouseOver=\"roll(this,'avanti')\" onMouseOut=\"noroll(this,'avanti')\" src='shell/<?php echo($path_img);?>/pulsante_avanti.gif' alt=\"Avanti\"><\/a>");
	document.write("<a id='pulsantehistory' href='#' accesskey='u' tabindex='900' onClick='indietrohistory();return false;' onKeypress='indietrohistory();return false;'><img id='history' onMouseOver=\"roll(this,'history')\" onMouseOut=\"noroll(this,'history')\" src='shell/<?php echo($path_img);?>/pulsante_history.gif' alt=\"Torna all'ultima pagina di test o al riepilogo\"><\/a>");
	document.write("<span id='pulsantecontinua'><a href='#' accesskey='q' tabindex='115' onClick=\"tutoriale('"+init_bookmark+"');return false;\" onKeyPress=\"tutoriale('"+init_bookmark+"');return false;\"><img id='continua' onMouseOver=\"roll(this,'continua')\" onMouseOut=\"noroll(this,'continua')\" src='shell/<?php echo($path_img);?>/pulsante_continua.gif' alt='Continua il corso al punto in cui ÃÂÃÂ¨ stato interrotto'></a><\/span>");
}
...
window.moveTo(0,0);
if (dimensionipagina==2){
	document.write("<link rel='stylesheet' href='shell/<?php echo($path_img);?>/tutoriale2.css' type='text/css'>");
	window.resizeTo(1024,755);
}
else{
	document.write("<link rel='stylesheet' href='shell/<?php echo($path_img);?>/hidden.css' type='text/css'>");
