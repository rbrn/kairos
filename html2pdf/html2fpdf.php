...
Misc. Observations:
- CSS + align = bug! (?)
OBS1: para textos de mais de 1 pÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½gina, talvez tenha que juntar varios $texto_artigo
...
//! @desc The footer is printed in every page!
    ...
    $this->SetY(-10);
    //Copyright //especial para esta versÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½o
  ...
  //Explode the string in order to parse the HTML code
	...
	foreach($a as $i => $e)
	{
      ...
      //Start of 'if/elseif's
          ...
          else $this->textbuffer[] = array("ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½"/*identifier*/.$this->specialcontent."ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½".$e);
      }
    ...
    case 'ADDRESS': 
      ...
      while (isset($this->cell[$this->row][$this->col])) $this->col++;
  		...
  		if ($this->table['nc'] < $this->col+1) $this->table['nc'] = $this->col+1;
			...
			//Chiem dung vi tri de danh cho cell span (ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½mais hein?)
          ...
          $srcpath = $attr['SRC'];
            ...
            switch($this->divalign)
            {
                ...
                default: break;
     				...
     				$this->textbuffer[] = array("ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½"/*identifier*/."type=image,ypos=$ypos,{$xpos}width=".$sizesarray['WIDTH'].",height=".$sizesarray['HEIGHT']."ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½".$sizesarray['OUTPUT']);
          ...
          else
          {
            ...
            if ($imgborder)
            {
                ...
                $this->Rect($ini_x,$ini_y,$sizesarray['WIDTH'],$sizesarray['HEIGHT']);
  				...
  				if ($this->tablestart)
  				{
     				$this->cell[$this->row][$this->col]['textbuffer'][] = array("ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½"/*identifier*/."type=image,width=".$sizesarray['WIDTH'].",height=".$sizesarray['HEIGHT']."ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½".$sizesarray['OUTPUT']);
      ...
      else //we are inside a table
      {
        ...
        switch(strtoupper($attr['TYPE'])){
          case 'CHECKBOX': //Draw Checkbox
                ...
                $type = 'CHECKBOX';
                $width = 4;
   			        $this->cell[$this->row][$this->col]['textbuffer'][] = array("ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½"/*identifier*/."type=input,subtype=$type,width=$width,height=$height"."ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½".$text);
...
//! @return void
	...
	if($tag=='CODE' or $tag=='PRE' or $tag=='TT' or $tag=='KBD' or $tag=='SAMP')
  {
    ...
    if ($this->tablestart)
    {
        $texto = "ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½".$this->specialcontent."ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½".$this->selectoption['SELECTED'];
        $aux = explode("ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$texto);
        $texto = $aux[2];
        $texto = "ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½".$aux[1].",width=$tamanho,height=".($this->lineheight + 2)."ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½".$texto;
...
//! @desc Prepares buffered text to be printed with FlowingBlock()
    ...
    for($i=0;$i < $array_size; $i++)
    {
      ...
      if (isset($vetor[0]) and $vetor[0]{0} == 'ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½' and $vetor[0]{1} == 'ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½' and $vetor[0]{2} == 'ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½') //identifier has been identified!
      {
        $content = explode("ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$vetor[0]);
        $texto = $content[2];
