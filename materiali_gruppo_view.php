...
<FRAMESET ROWS="220,*" BORDER="0" name="radice" id="radice">
	<FRAME SRC="materiali_gruppo_testata.php?id_risorsa=<?php echo($id_risorsa);?>" NAME="testata" MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING="NO" NORESIZE>
	...
	<FRAMESET COLS="*,200" BORDER="0" name="frame1" id="frame1">
		...
		<frame name="menu_sezioni" src="materiali_gruppo_indice.php?id_risorsa=<?php echo($id_risorsa);?>" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0" noresize>
