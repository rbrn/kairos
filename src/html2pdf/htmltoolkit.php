...
//returns an associative array (keys: R,G,B) from html code (e.g. #3FE5AA)
  ...
  {
  	$color = str_replace("rgb(",'',$color); //remove ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½rgb(ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½
  	$color = str_replace("RGB(",'',$color); //remove ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½RGB(ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ -- PHP < 5 does not have str_ireplace
  	$color = str_replace(")",'',$color); //remove ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½)ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½
    $cores = explode(",", $color);
    $color = array();
	  $color['R']=$cores[0];
	  $color['G']=$cores[1];
...
function lesser_entity_decode($html)
{
  //supports the most used entity codes
 	...
 	$html = str_replace("&lt;","<",$html);
 	$html = str_replace("&gt;",">",$html);
 	$html = str_replace("&laquo;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
 	$html = str_replace("&raquo;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
 	$html = str_replace("&para;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
 	$html = str_replace("&euro;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
 	$html = str_replace("&trade;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
 	$html = str_replace("&copy;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
 	$html = str_replace("&reg;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
 	$html = str_replace("&plusmn;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
 	$html = str_replace("&tilde;","~",$html);
 	$html = str_replace("&circ;","^",$html);
 	$html = str_replace("&quot;",'"',$html);
 	$html = str_replace("&permil;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
 	$html = str_replace("&Dagger;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
 	$html = str_replace("&dagger;","ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½",$html);
  return $html;
}
