...
<p>
<span class=testo>[<a href="#" title="<?php echo($stringa[elenco_img_alt]);?>" onclick="apri_scheda('index.php?risorsa=materiali_cartella&dir=gruppo&tipo=img&cartella=','myRemoteUtente',        'height=400,width=550,alwaysLowered=0,alwaysRaised=0,channelmode=0,dependent=0,directories=0,fullscreen=0,hotkeys=1,location=0,menubar=0,resizable=1,scrollbars=1,status=0,titlebar=1,toolbar=0,z-lock=0','myWindowUtente');"><?php echo($stringa[elenco_img]);?></a>]</span>
</p>
</td></tr>
</table>
</body>
