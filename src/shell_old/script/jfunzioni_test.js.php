...
function inviapunteggio(pagina){ // invia i punteggi
	...
	if (classepunteggio > 4){
		document.getElementById("feedback"+pagina).src = "shell/<? echo $path_img ?>/feed_01.jpg";
		document.getElementById("feedback"+pagina).alt = "Andiamo male: la missione ÃÂÃÂ¨ in pericolo";
	}
	else if (classepunteggio > 3){
		document.getElementById("feedback"+pagina).src = "shell/<? echo $path_img ?>/feed_02.jpg";
		document.getElementById("feedback"+pagina).alt = "Prestazione ancora modesta: fai attenzione";
	}
	else if (classepunteggio > 2){
		document.getElementById("feedback"+pagina).src = "shell/<? echo $path_img ?>/feed_03.jpg";
		document.getElementById("feedback"+pagina).alt = "Il successo ÃÂÃÂ¨ ancora lontano";
	}
	else if (classepunteggio > 1){
		document.getElementById("feedback"+pagina).src = "shell/<? echo $path_img ?>/feed_04.jpg";
		document.getElementById("feedback"+pagina).alt = "La situazione ÃÂÃÂ¨ incoraggiante: continua cosÃÂÃÂ¬";
	}
	else{
		document.getElementById("feedback"+pagina).src = "shell/<? echo $path_img ?>/feed_05.jpg";
		document.getElementById("feedback"+pagina).alt = "Prestazione esaltante: il successo ÃÂÃÂ¨ vicino";
	}
}		
	...
	if (nodovisitato[pagina] < 3)
		...
		switch (tipotutoriale[destinazione]){
			case 4: // riepilogo
				...
				var classepunteggio = (punteggiomassimo - punteggio)/(punteggiomassimo / 4);
				if (classepunteggio > 4){
					document.getElementById("feedback"+destinazione).src = "shell/<? echo $path_img ?>/riepilogo_01.jpg";
					document.getElementById("feedback"+destinazione).alt = "La missione ÃÂÃÂ¨ quasi fallita";
					inviamessaggio("Ce l'hai fatta per un pelo: la tua missione ÃÂÃÂ¨ quasi fallita.",destinazione);
				}
				else if (classepunteggio > 3){
					document.getElementById("feedback"+destinazione).src = "shell/<? echo $path_img ?>/riepilogo_02.jpg";
					document.getElementById("feedback"+destinazione).alt = "La prestazione ÃÂÃÂ¨ piuttosto modesta";
					inviamessaggio("Ce l'hai fatta, ma la tua prestazione ÃÂÃÂ¨ piuttosto modesta.",destinazione);
					}
				else if (classepunteggio > 2){
					document.getElementById("feedback"+destinazione).src = "shell/<? echo $path_img ?>/riepilogo_03.jpg";
					document.getElementById("feedback"+destinazione).alt = "Il successo ÃÂÃÂ¨ ancora lontano";
					inviamessaggio("Insomma... questa volta ÃÂÃÂ¨ andata cosÃÂÃÂ¬ cosÃÂÃÂ¬.",destinazione);
				}
				else if (classepunteggio > 1){
					document.getElementById("feedback"+destinazione).src = "shell/<? echo $path_img ?>/riepilogo_04.jpg";
					document.getElementById("feedback"+destinazione).alt = "La prestazione ÃÂÃÂ¨ superiore alla media";
					inviamessaggio("Bene! Una prestazione superiore alla media.",destinazione);
				}
				else{
					document.getElementById("feedback"+destinazione).src = "shell/<? echo $path_img ?>/riepilogo_05.jpg";
					document.getElementById("feedback"+destinazione).alt = "La prestazione ÃÂÃÂ¨ esaltante";
		...
		azzera();
		inviamessaggio("La tua missione ÃÂÃÂ¨ fallita. Ricomincia!",1,"ko");
		tutoriale(1);
	}
}
...
function verificatest(tipotest,pagina,rispostaesatta,punti,messaggiook,messaggioko,casesensitive){ // verifica test
	...
	switch (nodovisitato[pagina]){
		...
		case 2:
			...
			break;
		case 3:
			inviamessaggio("Hai giÃÂÃÂ  risposto. Vai avanti.",pagina,"audio_messaggio");
			break;
	}
}
