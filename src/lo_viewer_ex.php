...
$query="SELECT nome,cognome FROM utenti WHERE id_utente='$kairos_cookie[0]'";
$result=$mysqli->query($query);
$riga=$result->fetch_array();
$nome_utente=trim($riga["nome"])." ".trim($riga["cognome"]);
...
<p>
<strong>Consulenza didattica</strong><br>
Vindice Deplano
<p>
...
<p>
<strong>Sviluppo animazioni</strong><br>
