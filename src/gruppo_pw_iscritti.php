...
$query = "SELECT id_utente FROM iscrizioni_gruppo_pw WHERE id_gruppo='$id_gruppo' AND id_corso='$id_corso_s' AND id_edizione='$id_edizione_s' ORDER BY id_utente";
...
if ($cod_area=="kairos_eprof") {
	echo "<span class=testo>Per contribuire ai lavori di questo gruppo ÃÂÃÂ¯ÃÂÃÂ¿ÃÂÃÂ½ sufficiente [<a href=gruppo_pw_iscrizione.php?id_gruppo=$id_gruppo>iscriversi</a>]</span>
<br><br>";
};
echo "
