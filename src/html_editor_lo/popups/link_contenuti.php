...
[<a href=\"javascript:;\" onclick=\"apri_scheda('../../cerca_pagina_popup.php?campo=f_risorsa&dir=$dir&risorsa_padre=$risorsa_padre','cerca_popup','height=450,width=600,alwaysLowered=0,alwaysRaised=1,channelmode=0,dependent=1,directories=0,fullscreen=0,hotkeys=1,location=0,menubar=0,resizable=1,scrollbars=1,status=0,titlebar=1,toolbar=0,z-lock=1','win_cerca_popup')\">".$stringa["cerca"]."</a>]
[<a href=\"javascript:;\" onclick=\"apri_scheda('../../cerca_pagina_popup_op.php?campo=f_risorsa&dir=$dir&risorsa_padre=$risorsa_padre','cerca_popup','height=450,width=600,alwaysLowered=0,alwaysRaised=1,channelmode=0,dependent=1,directories=0,fullscreen=0,hotkeys=1,location=0,menubar=0,resizable=1,scrollbars=1,status=0,titlebar=1,toolbar=0,z-lock=1','win_cerca_popup')\">".$stringa["tutti"]."</a>]
";
?>
	</td>
  </tr>
