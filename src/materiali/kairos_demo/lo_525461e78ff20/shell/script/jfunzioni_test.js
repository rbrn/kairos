...
function mostrasoluzioni(tipotest,rispostaesatta,punti){ // presentazione soluzioni test
	...
	switch (tipotest){
		case 1: // domande a risposta chiusa
			while (document.getElementById("test_"+tutorialeattivo).elements[contatore]){
				if (document.getElementById("test_"+tutorialeattivo).elements[contatore].checked == true && contatore == rispostaesatta[1]){
					document.getElementById("testimm"+contatore+"_"+tutorialeattivo).src = "shell/img/feedback_ok.gif";
					...
					document.getElementById("testimm"+contatore+"_"+tutorialeattivo).src = "shell/img/feedback_ko.gif";
					...
					document.getElementById("testimm"+contatore+"_"+tutorialeattivo).src = "shell/img/vuoto.gif";
			...
			while (document.getElementById(sottopagina)){
				while (document.getElementById(sottopagina).elements[contatore]){
					if (document.getElementById(sottopagina).elements[contatore].checked == true && contatore == rispostaesatta[contatore1]){
						document.getElementById("testimm"+contatore1+"_"+tutorialeattivo).src = "shell/img/feedback_ok.gif";
						...
						document.getElementById("testimm"+contatore1+"_"+tutorialeattivo).src = "shell/img/feedback_ko.gif";
		...
		case 5: // domande con selezione di opzioni
			...
			break;
		case 6: // drag and drop in flash
			document.getElementById("testimm1_"+tutorialeattivo).src = "shell/img/feedback_ko.gif";
...
function visualizzacruciverba(pagina,caselle,definizione){
	...
	while (contatore <= numerocaselle){
		...
		if (caselle[contatore] == -1)
			document.write("<img class='casellanera' src='shell/img/cruci_nera.gif' alt='Casella nera'>");
		else{
			if (caselle[contatore]){
				...
				document.write("<img class='immaginecasella' src='shell/img/cruci_"+caselle[contatore]+".gif' alt='Casella "+caselle[contatore]+"'>");
			}
	...
	for (contatore=1; contatore<definizione.length; contatore++){
		...
		document.write("<label for='"+stringaid+"'>"+definizione[contatore][0]+". "+definizione[contatore][2]+" <img id='"+stringaimmid+"' class='immagineinlinea' src='shell/img/vuoto.gif' alt=''></label>");
		...
		document.write("<img class='immagineinlinea' onMouseOver=\"roll(this,'verifica2')\" onMouseOut=\"noroll(this,'verifica2')\" src='shell/img/pulsante_verifica2.gif' alt='Controlla'>");
		document.write("</a><br>");
	}
