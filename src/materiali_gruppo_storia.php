...
$query = "SELECT id_utente,DATE_FORMAT(data_evento,'%d/%m/%Y %H:%i') as data_r,evento FROM materiale_gruppo_storia WHERE id_risorsa='$id_risorsa' ORDER BY data_evento DESC";
