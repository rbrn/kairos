...
<FRAMESET ROWS="103,*" BORDER="0" name="radice" id="radice">
	...
	<FRAMESET COLS="*,250" BORDER="0" name="frame1" id="frame1">
<?php
...
?>
		...
		<frameset rows="*,170,50,0">
			<frame name="finestra_utenti" src="utenti_chat.php" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0" noresize>

			<frame name="audiochat" src="audiochat.php?canale=<?php echo $cod_area."_".$chat_stanza;?>" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0" noresize>

			<frame name="finestra_musica" src="musica_chat2.htm" marginwidth="0" marginheight="0" scrolling="auto" frameborder="0" noresize>
	
			<FRAME SRC="chat_loader2.php" NAME="loader" FRAMEBORDER="0" BORDER="0" FRAMESPACING="0" MARGINHEIGHT="0" MARGINWIDTH="0" SCROLLING="NO">
